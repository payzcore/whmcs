...
4. Find **PayzCore - Stablecoin Monitoring** and click **Activate**
...
| **Blockchain Network** | TRC20, BEP20, ERC20, Polygon, or Arbitrum | `TRC20` |
| **Token** | Stablecoin to monitor (USDT or USDC) | `USDT` |
...
- **POST /api/v1/payments** -- Create a monitoring request
- **GET /api/v1/payments/:id** -- Check payment status (real-time)
- **POST /api/v1/payments/:id/confirm** -- Submit transaction hash (static wallet mode)
