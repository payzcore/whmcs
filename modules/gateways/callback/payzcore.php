 ...
 * Supports multi-chain (TRC20, BEP20, ERC20, Polygon, Arbitrum) and
...
if (!PayzCoreApi::verifyWebhookSignature($rawBody, $signature, $webhookSecret)) {
...
$chain          = isset($payload['chain']) ? $payload['chain'] : '';
...
switch ($event) {
    ...
    case 'payment.overpaid':
        ...
        $logMessage = ($event === 'payment.overpaid')
            ...
            : 'Success (' . $paidAmount . ' ' . $token . ' on ' . $chain . ')';
