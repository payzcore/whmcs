 ...
 *   $chain        - TRC20, BEP20, ERC20, POLYGON, or ARBITRUM
 *   $chain_label  - Human-readable chain name (e.g., "Tron (TRC20)")
...
">
    ...
    ">
        ...
        <div style="text-align:center;font-size:11px;color:#52525b;border-top:1px solid rgba(255,255,255,0.05);padding-top:16px;margin-top:8px;">
            Send only <strong>{$token_name|escape:'html'|default:'USDT'}</strong> on <strong>{$chain_label|escape:'html'}</strong> to this address.<br>
